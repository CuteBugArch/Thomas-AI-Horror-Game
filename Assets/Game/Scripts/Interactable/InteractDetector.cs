...
public class InteractDetector : MonoBehaviour
{
    ...
    private void UpdateDetection()
    {
        ...
        // Mengecek apakah interaksi aktif
        if (Enabled == true)
        {
            // Mendapatkan reference ke component transform camera
            Transform cameraTransform = Camera.main.transform;
            ...
            if (isDetectingInteractable)
            {
                ...
                // ### direct run 
                //HidingCloset hidingCloset = hit.collider.gameObject
                //                         .GetComponentInParent<HidingCloset>();
                //IInteractable interactable = hidingCloset != null
                //    ? hidingCloset
